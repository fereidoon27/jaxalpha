...
def monitor_memory():
    ...
    logging.info(f"RSS: {mem_info.rss / 1024**3:.2f} GB, VMS: {mem_info.vms / 1024**3:.2f} GB")
...
def predict_structure(
  ...
  for model_index, (model_name, model_runner) in enumerate(
    ...
    monitor_memory()
    del processed_feature_dict, prediction_result, np_prediction_result, unrelaxed_protein
    gc.collect()
  ...
  for model_name in to_relax:
    ...
    # Monitor and manage memory usage
    monitor_memory()
    del relaxed_pdb_str, unrelaxed_proteins[model_name]
    gc.collect()
